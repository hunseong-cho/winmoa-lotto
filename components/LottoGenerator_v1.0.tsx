...
const LottoGenerator = () => {
  ...
  return (    
    <div className="flex flex-col items-center p-16 bg-gray-100 rounded-lg shadow-md space-y-8">
      ...
      <div className="mt-6 text-center">
        <h3 className="text-xl font-bold text-gray-700">📊 전체 누적 당첨 통계</h3>
        <p className="mt-2 text-gray-600">
          1등 {totalStats["1등"]}개, 2등 {totalStats["2등"]}개, 3등 {totalStats["3등"]}개, 
          4등 {totalStats["4등"]}개, 5등 {totalStats["5등"]}개
        </p>
      </div>

      <div className="mt-6 text-center">
        <h3 className="text-xl font-bold text-gray-700">📅 최근 5회차 당첨 통계</h3>
        <div className="space-y-2 mt-2">
          {roundStats.map(stat => (
            <div key={stat.round} className="text-gray-600">
              {stat.round}회차 ➜ 1등 {stat["1등"]}개, 2등 {stat["2등"]}개, 3등 {stat["3등"]}개,
              4등 {stat["4등"]}개, 5등 {stat["5등"]}개
            </div>
          ))}
        </div>
      </div>
      ...
      {!infoGenerated && (
        ...
        <div className="flex gap-2 mt-4">
          ...
          <input
            ...
            className="p-3 border rounded text-center w-24"
            value={birthYear}
            onChange={(e) => {
      ...
      {generatedHistory.length > 0 && (
        <div className="mt-8 p-4 border-t">
          ...
          <div className="w-full flex justify-center mb-4">
            <a href="https://www.mobing.co.kr/" target="_blank" rel="noopener noreferrer">
              <img src="/banner-ad.jpg" alt="광고 배너" className="w-full max-w-[728px] h-auto rounded-lg shadow-md"/>
            </a>
          </div>        
        </div>
      )}
